...
public enum SkelligeCards {
    ...
    BERSERKER("Berserker", 4, 1, Type.CLOSE_COMBAT_UNIT, new Berserker(), Description.TRANSFORMS_TO_VIDKAARL, false, "/gwentImages/img/lg/skellige_berserker.jpg"),
    ...
    KAMBI("Kambi", 11, 1, Type.CLOSE_COMBAT_UNIT, new Berserker(), Description.TURNS_INTO_STRONGER_CARD, true, "/gwentImages/img/lg/skellige_kambi.jpg"),
    ...
    CLAN_DIMUN_PIRATE("Clan Dimun Pirate", 6, 1, Type.RANGED_UNIT, new Scorch(), Description.KILLS_STRONGEST_OPPONENT, false, "/gwentImages/img/lg/skellige_dimun_pirate.jpg"),
    ...
    YOUNG_BERSERKER("Young Berserker", 2, 3, Type.RANGED_UNIT, new Berserker(), Description.TRANSFORMS_TO_YOUNG_VIDKAARL, false, "/gwentImages/img/lg/skellige_young_berserker.jpg"),
