...
public enum SkelligeCards implements CardEnum {
    ...
    HEMDALL("Hemdall", 11, 0, Type.CLOSE_COMBAT_UNIT, null, Description.NOTHING, true, "/gwentImages/img/lg/skellige_hemdall.jpg"),
    KAMBI("Kambi", 11, 1, Type.CLOSE_COMBAT_UNIT, new SummonAvenger(SkelligeCards.HEMDALL), Description.TURNS_INTO_STRONGER_CARD, true, "/gwentImages/img/lg/skellige_kambi.jpg"),
    ...
    public Card getCard() {
        return new Card(name, type, noOfCardsInGame, power, ability, isHero, Faction.SKELLIGE, description, imagePath, this);
    }
