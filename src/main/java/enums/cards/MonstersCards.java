...
public enum MonstersCards {
    ...
    CRONE_WEAVESS("Crone: Weavess", 6, 1, Type.CLOSE_COMBAT_UNIT, new Muster(), Description.NOTHING, false, "/gwentImages/img/lg/monsters_crone_weavess.jpg"),
    CRONE_WHISPESS("Crone: Whispess", 6, 1, Type.CLOSE_COMBAT_UNIT, new Muster(), Description.NOTHING, false, "/gwentImages/img/lg/monsters_crone_whispess.jpg"),
