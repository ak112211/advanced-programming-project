...
public enum MonstersCards implements CardEnum {
    ...
    ARACHAS_BEHEMOTH("Arachas Behemoth", 6, 1, Type.SIEGE_UNIT, new Muster("Arachas"), Description.NOTHING, false, "/gwentImages/img/lg/monsters_arachas_behemoth.jpg"),
    ...
    GHOUL("Ghoul", 1, 3, Type.CLOSE_COMBAT_UNIT, new Muster(), Description.NOTHING, false, "/gwentImages/img/lg/monsters_ghoul.jpg"),
    ...
    public Card getCard() {
        return new Card(name, type, noOfCardsInGame, power, ability, isHero, Faction.MONSTER, description, imagePath, this);
    }
