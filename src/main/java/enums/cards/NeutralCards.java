...
public enum NeutralCards implements CardEnum {
    ...
    TORRENTIAL_RAIN("Torrential Rain", 0, 3, Type.WEATHER, new Weather(Weather::doesAffectSiege), Description.SETS_RANGED_TO_ONE, false , "/gwentImages/img/lg/weather_fog.jpg"), //TODO
    ...
    VILLENTRETENMERTH("Villentretenmerth", 7, 1, Type.CLOSE_COMBAT_UNIT, new Spy(), Description.SCOTCH_ON_ENEMY_CLOSE_COMBAT, false, "/gwentImages/img/lg/neutral_villen.jpg"),
