...
import model.abilities.instantaneousabilities.Transformers;
...
public enum NeutralCards {
    ...
    TORRENTIAL_RAIN("Torrential Rain", 0, 3, Type.WEATHER, null, Description.SETS_SIEGE_TO_ONE, false, "/gwentImages/img/lg/weather_rain.jpg"),
    SKELLIGE_STORM("Skellige Storm", 0, 3, Type.WEATHER, null, Description.SETS_SIEGE_AND_RANGED_TO_ONE, false, "/gwentImages/img/lg/weather_storm.jpg"),
    CLEAR_WEATHER("Clear Weather", 0, 3, Type.WEATHER, null, Description.CANCELS_ALL_WEATHER_CARDS, false, "/gwentImages/img/lg/weather_clear.jpg"),
    SCORCH("Scorch", 0, 3, Type.SPELL, new Scorch(), Description.REMOVES_MAX_POWER_CARDS, false, "/gwentImages/img/lg/special_scorch.jpg"),
    ...
    VILLENTRETENMERTH("Villentretenmerth", 7, 1, Type.CLOSE_COMBAT_UNIT, new Scorch(), Description.SCOTCH_ON_ENEMY_CLOSE_COMBAT, false, "/gwentImages/img/lg/neutral_villen.jpg"),
